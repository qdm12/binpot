...
| [`docker`](https://github.com/docker/cli) | [`v20.10.16`](https://github.com/docker/cli/releases/tag/v20.10.16) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=docker) | all |
