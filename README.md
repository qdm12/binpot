...
| [`compose`](https://github.com/docker/compose) | [`v2.5.1`](https://github.com/docker/compose/releases/tag/v2.5.1) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=compose) | all |
...
| [`gh`](https://github.com/cli/cli) | [`v2.11.3`](https://github.com/cli/cli/releases/tag/v2.11.3) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=gh) | all |
