...
| [`buildx`](https://github.com/docker/buildx) | [`v0.6.2`](https://github.com/docker/buildx/releases/tag/v0.6.2) | [`:buildx`](https://hub.docker.com/r/qmcgaw/binpot/tags?name=buildx) | all |
