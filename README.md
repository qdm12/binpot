...
| [`golangci-lint`](https://github.com/golangci/golangci-lint) | [`v1.47.0`](https://github.com/golangci/golangci-lint/releases/tag/v1.47.0) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=golangci-lint) | all |
