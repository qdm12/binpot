...
| [`buildx`](https://github.com/docker/buildx) | [`v0.25.0`](https://github.com/docker/buildx/releases/tag/v0.25.0) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=buildx) | all |
| [`compose`](https://github.com/docker/compose) | [`v2.37.2`](https://github.com/docker/compose/releases/tag/v2.37.2) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=compose) | all |
| [`dlv`](https://github.com/go-delve/delve) | [`v1.25.0`](https://github.com/go-delve/delve/releases/tag/v1.25.0) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=dlv) | `linux/amd64` and `linux/arm64` |
| [`docker`](https://github.com/docker/cli) | [`v28.2.2`](https://github.com/docker/cli/releases/tag/v28.2.2) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=docker) | all |
| [`gh`](https://github.com/cli/cli) | [`v2.74.2`](https://github.com/cli/cli/releases/tag/v2.74.2) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=gh) | all |
...
| [`gopls`](https://github.com/golang/tools/tree/master/gopls) | [`v0.19.1`](https://github.com/golang/tools/releases/tag/gopls/v0.19.1) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=gopls) | all |
...
| [`helm`](https://github.com/helm/helm) | [`v3.18.3`](https://github.com/helm/helm/releases/tag/v3.18.3) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=helm) | all |
...
| [`mockery`](https://github.com/vektra/mockery) | [`v3.4.0`](https://github.com/vektra/mockery/releases/tag/v3.4.0) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=mockery) | all |
