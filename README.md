...
| [`compose`](https://github.com/docker/compose) | [`v2.6.0`](https://github.com/docker/compose/releases/tag/v2.6.0) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=compose) | all |
| [`dlv`](https://github.com/go-delve/delve) | [`v1.8.3`](https://github.com/go-delve/delve/releases/tag/v1.8.3) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=dlv) | `linux/amd64` and `linux/arm64` |
...
| [`gh`](https://github.com/cli/cli) | [`v2.12.0`](https://github.com/cli/cli/releases/tag/v2.12.0) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=gh) | all |
...
| [`gopls`](https://github.com/golang/tools/tree/master/gopls) | [`v0.8.4`](https://github.com/golang/tools/releases/tag/gopls/v0.8.4) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=gopls) | all |
...
| [`helm`](https://github.com/helm/helm) | [`v3.9.0`](https://github.com/helm/helm/releases/tag/v3.9.0) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=helm) | all |
...
| [`kubectl`](https://github.com/kubernetes/kubernetes) | [`v1.24.1`](https://github.com/kubernetes/kubernetes/releases/tag/v1.24.1) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=kubectl) | all |
...
| [`mockery`](https://github.com/vektra/mockery) | [`v2.12.3`](https://github.com/vektra/mockery/releases/tag/v2.12.3) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=mockery) | all |
