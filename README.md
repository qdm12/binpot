...
| [`kubectl`](https://github.com/kubernetes/kubernetes) | [`v1.23.5`](https://github.com/kubernetes/kubernetes/releases/tag/v1.23.5) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=kubectl) | all |
