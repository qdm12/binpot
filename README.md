...
| [`golangci-lint`](https://github.com/golangci/golangci-lint) | [`v1.47.2`](https://github.com/golangci/golangci-lint/releases/tag/v1.47.2) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=golangci-lint) | all |
