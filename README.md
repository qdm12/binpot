...
| [`buildx`](https://github.com/docker/buildx) | [`v0.33.0`](https://github.com/docker/buildx/releases/tag/v0.33.0) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=buildx) | all |
| [`compose`](https://github.com/docker/compose) | [`v5.1.1`](https://github.com/docker/compose/releases/tag/v5.1.1) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=compose) | all |
| [`dlv`](https://github.com/go-delve/delve) | [`v1.26.1`](https://github.com/go-delve/delve/releases/tag/v1.26.1) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=dlv) | `linux/amd64` and `linux/arm64` |
| [`docker`](https://github.com/docker/cli) | [`v29.4.0`](https://github.com/docker/cli/releases/tag/v29.4.0) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=docker) | all |
| [`gh`](https://github.com/cli/cli) | [`v2.89.0`](https://github.com/cli/cli/releases/tag/v2.89.0) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=gh) | all |
| [`gofumpt`](https://github.com/mvdan/gofumpt) | [`v0.9.2`](https://github.com/mvdan/gofumpt/releases/tag/v0.9.2) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=gofumpt) | all |
| [`golangci-lint`](https://github.com/golangci/golangci-lint) | [`v2.11.4`](https://github.com/golangci/golangci-lint/releases/tag/v2.11.4) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=golangci-lint) | all |
| [`gomock`](https://github.com/uber-go/mock) | [`v0.6.0`](https://github.com/uber-go/mock/releases/tag/v0.6.0) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=gomock) | all |
...
| [`gopls`](https://github.com/golang/tools/tree/master/gopls) | [`v0.21.1`](https://github.com/golang/tools/releases/tag/gopls/v0.21.1) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=gopls) | all |
| [`gotests`](https://github.com/cweill/gotests) | [`v1.9.0`](https://github.com/cweill/gotests/releases/tag/v1.9.0) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=gotests) | all |
| [`helm`](https://github.com/helm/helm) | [`v4.1.3`](https://github.com/helm/helm/releases/tag/v4.1.3) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=helm) | all |
...
| [`kubectl`](https://github.com/kubernetes/kubernetes) | [`v1.35.3`](https://github.com/kubernetes/kubernetes/releases/tag/v1.35.3) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=kubectl) | all |
| [`kubectx`](https://github.com/ahmetb/kubectx) | [`v0.11.0`](https://github.com/ahmetb/kubectx/releases/tag/v0.11.0) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=kubectx) | all |
| [`kubens`](https://github.com/ahmetb/kubectx) | [`v0.11.0`](https://github.com/ahmetb/kubectx/releases/tag/v0.11.0) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=kubens) | all |
...
| [`mockery`](https://github.com/vektra/mockery) | [`v3.7.0`](https://github.com/vektra/mockery/releases/tag/v3.7.0) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=mockery) | all |
...
| [`stern`](https://github.com/stern/stern) | [`v1.33.1`](https://github.com/stern/stern/releases/tag/v1.33.1) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=stern) | all |
