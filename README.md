...
| [`buildx`](https://github.com/docker/buildx) | [`v0.11.2`](https://github.com/docker/buildx/releases/tag/v0.11.2) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=buildx) | all |
| [`compose`](https://github.com/docker/compose) | [`v2.19.1`](https://github.com/docker/compose/releases/tag/v2.19.1) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=compose) | all |
| [`dlv`](https://github.com/go-delve/delve) | [`v1.21.0`](https://github.com/go-delve/delve/releases/tag/v1.21.0) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=dlv) | `linux/amd64` and `linux/arm64` |
| [`docker`](https://github.com/docker/cli) | [`v24.0.5`](https://github.com/docker/cli/releases/tag/v24.0.5) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=docker) | all |
| [`gh`](https://github.com/cli/cli) | [`v2.32.1`](https://github.com/cli/cli/releases/tag/v2.32.1) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=gh) | all |
| [`golangci-lint`](https://github.com/golangci/golangci-lint) | [`v1.53.3`](https://github.com/golangci/golangci-lint/releases/tag/v1.53.3) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=golangci-lint) | all |
...
| [`gopls`](https://github.com/golang/tools/tree/master/gopls) | [`v0.12.4`](https://github.com/golang/tools/releases/tag/gopls/v0.12.4) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=gopls) | all |
...
| [`helm`](https://github.com/helm/helm) | [`v3.12.3`](https://github.com/helm/helm/releases/tag/v3.12.3) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=helm) | all |
...
| [`kubectl`](https://github.com/kubernetes/kubernetes) | [`v1.27.4`](https://github.com/kubernetes/kubernetes/releases/tag/v1.27.4) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=kubectl) | all |
...
| [`mockery`](https://github.com/vektra/mockery) | [`v2.30.18`](https://github.com/vektra/mockery/releases/tag/v2.30.18) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=mockery) | all |
