...
| [`compose`](https://github.com/docker/compose) | [`v2.4.1`](https://github.com/docker/compose/releases/tag/v2.4.1) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=compose) | all |
...
| [`kubectl`](https://github.com/kubernetes/kubernetes) | [`v1.23.6`](https://github.com/kubernetes/kubernetes/releases/tag/v1.23.6) | [**Docker Hub**](https://hub.docker.com/r/qmcgaw/binpot/tags?name=kubectl) | all |
